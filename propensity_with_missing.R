...
covariates <- c('AGE', 'GENDER', 'RACE',  'TEACHINGSTATUS', 'SBP', 'PULSE', 'RR',    'GCSEYE', 'GCSVERB', 'GCSMOT', 'GCS_Q1','RRAQ', 'Head_Neck', 'Face', 'Thorax', 'Abdomen', 'Extremities', 'External', 'splenic', 'kidney', 'liver', 'femur_fracture', 'tibia_fracture',  'pelvis', 'lower_extremity_vascular', 'iliac_vascular', 'any_vascular', 'ISS', missing_indicators)

if  (! file.exists('data/A_alldeceased.rds') ){
    source('preprocess.R')
}
A <- readRDS('data/A_missing_indicators.rds')
...
covariates_toprint <- c('AGE', 'GENDER', 'RACE',  'TEACHINGSTATUS', 'SBP', 'PULSE', 'RR','GCS',  'Head_Neck', 'Face', 'Thorax', 'Abdomen', 'Extremities', 'External', 'splenic', 'kidney', 'liver', 'femur_fracture', 'tibia_fracture',  'pelvis', 'lower_extremity_vascular', 'iliac_vascular', 'any_vascular', 'ISS',missing_indicators )
# Usng Arsenal
...
summary(tunweighted, text=T)
summary(tweighted, text=T)
...
################################
#  Mortality treatment effect and sensitivity analysis
################################
